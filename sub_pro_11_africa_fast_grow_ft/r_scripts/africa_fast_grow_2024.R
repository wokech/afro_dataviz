...
ggsave("sub_pro_11_africa_fast_grow_ft/images/2024/origin_2024_treemap.png", width = 12, height = 12, dpi = 300)
...
table_data_2024_clean_sector_treemap <- table_data_2024_clean |>
  ...
  mutate(sector = recode(sector, "Professional, Scientific & Technical Services" = "Professional,\nScientific &\nTechnical Services")) |>
  group_by(sector) |>
  summarise(total = n()) |>
  arrange(desc(total)) |>
  mutate(group = if_else(row_number() <= 5,
...
ggsave("sub_pro_11_africa_fast_grow_ft/images/2024/sector_2024_treemap.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_11_africa_fast_grow_ft/images/2024/year_2024_treemap.png", width = 12, height = 12, dpi = 300)
...
ggplot(data = africa_top_5) +
  ...
  theme(plot.title = element_text(family = "Helvetica",size = 16, hjust = 0.5),
        ...
        legend.position = "none") +
  scale_fill_manual(values = color_map_2024)

ggsave("sub_pro_11_africa_fast_grow_ft/images/2024/origin_2024_map_match.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_11_africa_fast_grow_ft/images/2024/origin_2024_treemap_match.png", width = 12, height = 12, dpi = 300)
