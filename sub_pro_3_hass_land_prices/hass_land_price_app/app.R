  ...
  navbarPage(
    h4("Exploring land prices in Nairobi\nand its satellite towns"),
     tabPanel(h4("Introduction"),
              ...
              p(h4("The HassConsult Property Index is a quarterly publication, generated by HassConsult Limited, that provides multiple stakeholders with current and historical information related to land prices. HassConsult Limited, headquartered in Nairobi, has been in operation since 1992 and engages in all aspects of real estate development."))
              ),
     tabPanel(h4("Suburbs"),
              tabsetPanel(
