...
ggplot(africa_country_GDP_clean_top_5_bottom_total_new_col, 
  ...
  labs(title = "Over half of Africa's GDP is generated by 5 countries",
       subtitle = "Nigeria, Egypt, South Africa, Algeria, and Ethiopia accounted for about 52% of Africa's GDP in 2022",
       fill = "",
       caption = "Data Source: Wikipedia") +
  ...
  theme(legend.position = "bottom",
        ...
        plot.caption = element_text(size = 15, hjust = 0, vjust = 1),
