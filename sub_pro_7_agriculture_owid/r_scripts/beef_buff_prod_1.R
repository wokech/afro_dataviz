...
p1 <- beef_buff_prod_clean_region_non_fao_continent |> 
...
p2 <- beef_buff_prod_clean_region_non_fao_continent |> 
...
ggsave("sub_pro_7_agriculture_owid/images/continental_combi/beef_buff.png", width = 12, height = 16, dpi = 300)
...
p3 <- beef_buff_prod_clean_region_fao_africa_segment |> 
  ggplot(aes(year, beef_buff_production_tonnes, fill = region, label = region, color = region)) +
  geom_area() +
  geom_text_repel(
...
p4 <- beef_buff_prod_clean_region_fao_africa_segment |> 
  ggplot(aes(year, beef_buff_production_tonnes, fill = region, color = region)) +
  geom_area(position = "fill") +
  geom_text_repel(
...
ggsave("sub_pro_7_agriculture_owid/images/continental_africa_only_combi/beef_buff.png", width = 12, height = 16, dpi = 300)
