...
# african_countries[!(african_countries %in% unique(global_sugar_cane_clean_africa$country))]

# african_countries[!(african_countries %in% unique(share_net_clean_africa$country))]
#############

# Global sugar_cane Production in Africa
...
unique(sugar_cane_prod_clean_africa$country)

# Countries that don't have data
setdiff(african_countries, unique(sugar_cane_prod_clean_africa$country))

# Check whether any countries in the dataset are not in the list of African countries
setdiff(unique(sugar_cane_prod_clean_africa$country), african_countries)
...
sugar_cane_prod_clean_africa_rnaturalearth |>
  arrange(desc(sugar_cane_production)) |>
  filter(year == 2020) |>
  top_n(1)

top_3 <- sugar_cane_prod_clean_africa_rnaturalearth |>
  arrange(desc(sugar_cane_production)) |>
  filter(year == 2020) |>
  top_n(3)

bottom_3 <- sugar_cane_prod_clean_africa_rnaturalearth |>
  arrange(desc(sugar_cane_production)) |>
  filter(year == 2020) |>
  top_n(-3)
################################################################################
...
# 2) Map of countries showing global sugar_cane production between 1965 and 2020
...
# Find rows only in global_sugar_cane_clean_africa_1965
...
# Find rows only in global_sugar_cane_clean_africa_1970
...
# Find rows only in global_sugar_cane_clean_africa_1975
...
# Find rows only in global_sugar_cane_clean_africa_1980
...
# Find rows only in global_sugar_cane_clean_africa_1985
...
# Find rows only in global_sugar_cane_clean_africa_1990
...
# Find rows only in global_sugar_cane_clean_africa_1995
...
# Find rows only in global_sugar_cane_clean_africa_2000
...
# Find rows only in global_sugar_cane_clean_africa_2005
...
# Find rows only in global_sugar_cane_clean_africa_2010
...
# Find rows only in global_sugar_cane_clean_africa_2015
...
# Find rows only in global_sugar_cane_clean_africa_2020
