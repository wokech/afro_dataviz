...
p1 <- aquaculture_clean_region_wb |> 
  ...
  scale_y_continuous(limits = c(0, 130000000), labels  = 
...
p2 <- aquaculture_clean_region_wb |> 
...
ggsave("sub_pro_7_agriculture_owid/images/continental_combi/aquaculture.png", width = 12, height = 16, dpi = 300)



####NO AFRICA REGION DATA ####