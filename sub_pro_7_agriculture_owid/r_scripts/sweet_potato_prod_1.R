...
sweet_potato_prod_clean_region_non_fao_continent |> 
  ...
  geom_text_repel(
    data = label_df_sweet_potato_percent,
    aes(x = x_label, y = y_mid, label = region, color = region),
    hjust = 0,
    fontface = "bold",
    size = 8,
...
# 4) Sweet Potato production in Africa
...
sweet_potato_prod_clean_region_fao_africa_segment %>% 
  ...
  geom_area() +
  geom_text_repel(
    data = label_df_sweet_potato_africa,
    aes(x = x_label, y = y_mid, label = region, color = region),
    hjust = 0.1,
    fontface = "bold",
    size = 8,
...
sweet_potato_prod_clean_region_fao_africa_segment %>% 
  ...
  geom_area(position = "fill") +
  geom_text_repel(
    data = label_df_sweet_potato_percent_africa,
    aes(x = x_label, y = y_mid, label = region, color = region),
    hjust = 0.1,
    fontface = "bold",
    size = 8,
