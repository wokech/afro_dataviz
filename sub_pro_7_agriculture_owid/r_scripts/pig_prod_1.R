...
pig_prod_clean_region_non_fao_continent %>% 
  ggplot(aes(year, pig_production_tonnes, fill = country, label = country, color = country)) +
  geom_area() +
  labs(x = "Year",
...
ggsave("sub_pro_7_agriculture_owid/images/continent_pig_meat_1.png", width = 12, height = 12, dpi = 72)
