# Avocado Production Time Series
...
avocado_prod_clean_africa_rnaturalearth <- avocado_prod_clean_africa %>%
  ...
  rename(avocado_production = "avocados_dry_00000176_production_005510_tonnes")
...
avocado_prod_clean_africa_1965 <- avocado_prod_clean_africa_rnaturalearth |> 
  filter(year == 1965) |>
...
avocado_prod_clean_africa_1965_full_join <- full_join(africa, 
                                                   avocado_prod_clean_africa_1965,
                                                   by = c("admin" = "country"))

# Find rows only in africa

avocado_prod_clean_africa_1965_anti_join_1 <- anti_join(africa, 
                                                     avocado_prod_clean_africa_1965, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/avocado_time_series/avocado_clean_africa_map_1965.png", width = 9, height = 16, dpi = 300)
