# Tea Leaves Production Time Series
...
tea_leaves_prod_clean_africa_rnaturalearth <- tea_leaves_prod_clean_africa %>%
  mutate(country = case_when(
...
tea_leaves_prod_clean_africa_1965 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 1965) |>
...
tea_leaves_prod_clean_africa_1965_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_1965,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_1965_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_1965, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_1965.png", width = 9, height = 16, dpi = 300)



# Get 1970 data

tea_leaves_prod_clean_africa_1970 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 1970) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_1970_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_1970,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_1970_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_1970, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_1970.png", width = 9, height = 16, dpi = 300)



# Get 1975 data

tea_leaves_prod_clean_africa_1975 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 1975) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_1975_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_1975,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_1975_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_1975, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_1975.png", width = 9, height = 16, dpi = 300)



# Get 1980 data

tea_leaves_prod_clean_africa_1980 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 1980) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_1980_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_1980,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_1980_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_1980, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_1980.png", width = 9, height = 16, dpi = 300)



# Get 1985 data

tea_leaves_prod_clean_africa_1985 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 1985) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_1985_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_1985,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_1985_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_1985, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_1985.png", width = 9, height = 16, dpi = 300)



# Get 1990 data

tea_leaves_prod_clean_africa_1990 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 1990) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_1990_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_1990,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_1990_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_1990, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_1990.png", width = 9, height = 16, dpi = 300)



# Get 1995 data

tea_leaves_prod_clean_africa_1995 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 1995) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_1995_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_1995,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_1995_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_1995, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_1995.png", width = 9, height = 16, dpi = 300)



# Get 2000 data

tea_leaves_prod_clean_africa_2000 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 2000) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_2000_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_2000,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_2000_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_2000, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_2000.png", width = 9, height = 16, dpi = 300)



# Get 2005 data

tea_leaves_prod_clean_africa_2005 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 2005) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_2005_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_2005,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_2005_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_2005, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_2005.png", width = 9, height = 16, dpi = 300)



# Get 2010 data

tea_leaves_prod_clean_africa_2010 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 2010) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_2010_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_2010,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_2010_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_2010, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_2010.png", width = 9, height = 16, dpi = 300)



# Get 2015 data

tea_leaves_prod_clean_africa_2015 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 2015) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_2015_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_2015,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_2015_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_2015, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_2015.png", width = 9, height = 16, dpi = 300)



# Get 2020 data

tea_leaves_prod_clean_africa_2020 <- tea_leaves_prod_clean_africa_rnaturalearth |> 
  filter(year == 2020) |>
  arrange(desc(tea_leaves_production))
...
tea_leaves_prod_clean_africa_2020_full_join <- full_join(africa, 
                                                   tea_leaves_prod_clean_africa_2020,
                                                   by = c("admin" = "country"))

# Find rows only in africa

tea_leaves_prod_clean_africa_2020_anti_join_1 <- anti_join(africa, 
                                                     tea_leaves_prod_clean_africa_2020, 
                                                     by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/tea_leaves_time_series/tea_leaves_clean_africa_map_2020.png", width = 9, height = 16, dpi = 300)
