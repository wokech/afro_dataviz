# Mushroom Production Time Series
...
mushroom_prod_clean_africa_rnaturalearth <- mushroom_prod_clean_africa %>%
  mutate(country = case_when(
...
mushroom_prod_clean_africa_1965 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 1965) |>
...
mushroom_prod_clean_africa_1965_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_1965,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_1965_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_1965, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_1965.png", width = 9, height = 16, dpi = 300)



# Get 1970 data

mushroom_prod_clean_africa_1970 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 1970) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_1970_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_1970,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_1970_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_1970, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_1970.png", width = 9, height = 16, dpi = 300)



# Get 1975 data

mushroom_prod_clean_africa_1975 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 1975) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_1975_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_1975,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_1975_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_1975, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_1975.png", width = 9, height = 16, dpi = 300)



# Get 1980 data

mushroom_prod_clean_africa_1980 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 1980) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_1980_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_1980,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_1980_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_1980, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_1980.png", width = 9, height = 16, dpi = 300)



# Get 1985 data

mushroom_prod_clean_africa_1985 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 1985) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_1985_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_1985,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_1985_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_1985, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_1985.png", width = 9, height = 16, dpi = 300)



# Get 1990 data

mushroom_prod_clean_africa_1990 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 1990) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_1990_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_1990,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_1990_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_1990, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_1990.png", width = 9, height = 16, dpi = 300)



# Get 1995 data

mushroom_prod_clean_africa_1995 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 1995) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_1995_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_1995,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_1995_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_1995, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_1995.png", width = 9, height = 16, dpi = 300)



# Get 2000 data

mushroom_prod_clean_africa_2000 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 2000) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_2000_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_2000,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_2000_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_2000, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_2000.png", width = 9, height = 16, dpi = 300)



# Get 2005 data

mushroom_prod_clean_africa_2005 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 2005) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_2005_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_2005,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_2005_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_2005, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_2005.png", width = 9, height = 16, dpi = 300)



# Get 2010 data

mushroom_prod_clean_africa_2010 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 2010) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_2010_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_2010,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_2010_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_2010, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_2010.png", width = 9, height = 16, dpi = 300)



# Get 2015 data

mushroom_prod_clean_africa_2015 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 2015) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_2015_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_2015,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_2015_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_2015, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_2015.png", width = 9, height = 16, dpi = 300)



# Get 2020 data

mushroom_prod_clean_africa_2020 <- mushroom_prod_clean_africa_rnaturalearth |> 
  filter(year == 2020) |>
  arrange(desc(mushroom_production))
...
mushroom_prod_clean_africa_2020_full_join <- full_join(africa, 
                                                         mushroom_prod_clean_africa_2020,
                                                         by = c("admin" = "country"))

# Find rows only in africa

mushroom_prod_clean_africa_2020_anti_join_1 <- anti_join(africa, 
                                                           mushroom_prod_clean_africa_2020, 
                                                           by = c("admin" = "country"))
...
ggsave("sub_pro_7_agriculture_owid/images/mushroom_time_series/mushroom_clean_africa_map_2020.png", width = 9, height = 16, dpi = 300)
