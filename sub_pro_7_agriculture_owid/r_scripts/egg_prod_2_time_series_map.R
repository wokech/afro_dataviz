...
egg_prod_clean_africa <- egg_prod_clean |>
...
egg_prod_clean_africa_rnaturalearth <- egg_prod_clean_africa %>%
  mutate(country = case_when(
...
egg_prod_clean_africa_1965 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 1965) |>
...
egg_prod_clean_africa_1965_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_1965,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_1965_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_1965, 
                                                        by = c("admin" = "country"))
...
p1 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_1965_full_join, aes(fill = egg_production), linewidth = 1) +
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_1965.png", width = 9, height = 16, dpi = 300)



# Get 1970 data

egg_prod_clean_africa_1970 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 1970) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_1970_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_1970,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_1970_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_1970, 
                                                        by = c("admin" = "country"))
...
p2 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_1970_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_1970.png", width = 9, height = 16, dpi = 300)



# Get 1975 data

egg_prod_clean_africa_1975 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 1975) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_1975_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_1975,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_1975_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_1975, 
                                                        by = c("admin" = "country"))
...
p3 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_1975_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_1975.png", width = 9, height = 16, dpi = 300)



# Get 1980 data

egg_prod_clean_africa_1980 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 1980) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_1980_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_1980,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_1980_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_1980, 
                                                        by = c("admin" = "country"))
...
p4 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_1980_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_1980.png", width = 9, height = 16, dpi = 300)



# Get 1985 data

egg_prod_clean_africa_1985 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 1985) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_1985_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_1985,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_1985_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_1985, 
                                                        by = c("admin" = "country"))
...
p5 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_1985_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_1985.png", width = 9, height = 16, dpi = 300)



# Get 1990 data

egg_prod_clean_africa_1990 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 1990) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_1990_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_1990,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_1990_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_1990, 
                                                        by = c("admin" = "country"))
...
p6 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_1990_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_1990.png", width = 9, height = 16, dpi = 300)



# Get 1995 data

egg_prod_clean_africa_1995 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 1995) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_1995_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_1995,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_1995_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_1995, 
                                                        by = c("admin" = "country"))
...
p7 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_1995_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_1995.png", width = 9, height = 16, dpi = 300)



# Get 2000 data

egg_prod_clean_africa_2000 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 2000) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_2000_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_2000,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_2000_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_2000, 
                                                        by = c("admin" = "country"))
...
p8 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_2000_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_2000.png", width = 9, height = 16, dpi = 300)



# Get 2005 data

egg_prod_clean_africa_2005 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 2005) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_2005_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_2005,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_2005_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_2005, 
                                                        by = c("admin" = "country"))
...
p9 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_2005_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_2005.png", width = 9, height = 16, dpi = 300)



# Get 2010 data

egg_prod_clean_africa_2010 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 2010) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_2010_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_2010,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_2010_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_2010, 
                                                        by = c("admin" = "country"))
...
p10 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_2010_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_2010.png", width = 9, height = 16, dpi = 300)



# Get 2015 data

egg_prod_clean_africa_2015 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 2015) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_2015_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_2015,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_2015_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_2015, 
                                                        by = c("admin" = "country"))
...
p11 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_2015_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
...
ggsave("sub_pro_7_agriculture_owid/images/egg_time_series/egg_clean_africa_map_2015.png", width = 9, height = 16, dpi = 300)



# Get 2020 data

egg_prod_clean_africa_2020 <- egg_prod_clean_africa_rnaturalearth |> 
  filter(year == 2020) |>
  arrange(desc(egg_production))
...
egg_prod_clean_africa_2020_full_join <- full_join(africa, 
                                                      egg_prod_clean_africa_2020,
                                                      by = c("admin" = "country"))

# Find rows only in africa

egg_prod_clean_africa_2020_anti_join_1 <- anti_join(africa, 
                                                        egg_prod_clean_africa_2020, 
                                                        by = c("admin" = "country"))
...
p12 <- ggplot(data = africa) +
  geom_sf() + 
  geom_sf(data = egg_prod_clean_africa_2020_full_join, aes(fill = egg_production), linewidth = 1) +
  scale_fill_distiller(palette = "YlGnBu", 
                       direction = 1,
                       limits = c(0, 800000),
                       labels  = label_number(scale = 1e-6),
