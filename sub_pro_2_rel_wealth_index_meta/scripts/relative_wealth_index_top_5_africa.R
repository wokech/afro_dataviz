...
# Read the CSV file
zaf_data <- read_csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/zaf_relative_wealth_index.csv"
)

# Convert the data to an sf object
zaf_data_sf <- st_as_sf(
  zaf_data,
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/south_africa.png",
  width = 12,
  height = 12,
  dpi = 72
)
...
# Read the CSV file
egy_data <- read_csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/egy_relative_wealth_index.csv"
)

# Convert the data to an sf object
egy_data_sf <- st_as_sf(
  egy_data,
  coords = c("longitude", "latitude"),
  crs = 4326
)
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/egypt.png",
  width = 12,
  height = 12,
  dpi = 72
)
...
# Read the CSV file
alg_data <- read_csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/alg_relative_wealth_index.csv"
)

# Convert the data to an sf object
alg_data_sf <- st_as_sf(
  alg_data,
  coords = c("longitude", "latitude"),
  crs = 4326
)
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/algeria.png",
  width = 12,
  height = 12,
  dpi = 72
)
...
# Read the CSV file
nga_data <- read_csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/nga_relative_wealth_index.csv"
)

# Convert the data to an sf object
nga_data_sf <- st_as_sf(
  nga_data,
  coords = c("longitude", "latitude"),
  crs = 4326
)
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/nigeria.png",
  width = 12,
  height = 12,
  dpi = 72
)
...
# Read the CSV file
mor_data <- read_csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/mor_relative_wealth_index.csv"
) %>%
  select(-quadkey)

# Convert the data to an sf object
mor_data_sf <- st_as_sf(
  mor_data,
  coords = c("longitude", "latitude"),
  crs = 4326
)
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/morocco.png",
  width = 12,
  height = 12,
  dpi = 72
)
