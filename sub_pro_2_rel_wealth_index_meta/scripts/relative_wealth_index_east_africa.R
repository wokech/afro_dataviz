...
# Read the CSV file
ken_data <- read.csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/ken_relative_wealth_index.csv"
)

# Convert the data to an sf object
ken_data_sf <- st_as_sf(
  ken_data,
...
ggplot() +
  ...
  geom_point(
    data = ken_data,
    aes(x = longitude, y = latitude, color = rwi),
    size = 0.5,
    alpha = 0.8
  ) +
  geom_text_repel(
    data = major_towns_kenya,
  ...
  theme_void() +
  labs(
    title = "Wealth Index Distribution in Kenya",
    subtitle = "",
...
# Read the CSV file
tza_data <- read.csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/tza_relative_wealth_index.csv"
)

# Convert the data to an sf object
tza_data_sf <- st_as_sf(
  tza_data,
  coords = c("longitude", "latitude"),
  crs = 4326
)
...
ggplot() +
  ...
  theme_void() +
  labs(
    title = "Wealth Index Distribution in Tanzania",
    subtitle = "",
    caption = "Data Source: Meta (Data for Good)",
    color = "Relative Wealth Index"
  ) +
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/tanzania.png",
  width = 12,
  height = 12,
  dpi = 72
)
...
# Read the CSV file
uga_data <- read.csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/uga_relative_wealth_index.csv"
)

# Convert the data to an sf object
uga_data_sf <- st_as_sf(
  uga_data,
  coords = c("longitude", "latitude"),
  crs = 4326
)
...
ggplot() +
  ...
  theme_void() +
  labs(
    title = "Wealth Index Distribution in Uganda",
    subtitle = "",
    caption = "Data Source: Meta (Data for Good)",
    color = "Relative Wealth Index"
  ) +
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/uganda.png",
  width = 12,
  height = 12,
  dpi = 72
)
...
# Read the CSV file
bdi_data <- read.csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/bdi_relative_wealth_index.csv"
)

# Convert the data to an sf object
bdi_data_sf <- st_as_sf(
  bdi_data,
  coords = c("longitude", "latitude"),
  crs = 4326
)
...
ggplot() +
  ...
  theme_void() +
  labs(
    title = "Wealth Index Distribution in Burundi",
    subtitle = "",
    caption = "Data Source: Meta (Data for Good)",
    color = "Relative Wealth Index"
  ) +
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/burundi.png",
  width = 12,
  height = 12,
  dpi = 72
)
...
# Read the CSV file
rwa_data <- read.csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/rwa_relative_wealth_index.csv"
)

# Convert the data to an sf object
rwa_data_sf <- st_as_sf(
  rwa_data,
  coords = c("longitude", "latitude"),
  crs = 4326
)
...
ggplot() +
  ...
  theme_void() +
  labs(
    title = "Wealth Index Distribution in Rwanda",
    subtitle = "",
    caption = "Data Source: Meta (Data for Good)",
    color = "Relative Wealth Index"
  ) +
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/rwanda.png",
  width = 12,
  height = 12,
  dpi = 72
)
...
# Read the CSV file
cod_data <- read.csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/cod_relative_wealth_index.csv"
)

# Convert the data to an sf object
cod_data_sf <- st_as_sf(
  cod_data,
  coords = c("longitude", "latitude"),
  crs = 4326
)
...
ggplot() +
  ...
  theme_void() +
  labs(
    title = "Wealth Index Distribution in the DR Congo",
    subtitle = "",
    caption = "Data Source: Meta (Data for Good)",
    color = "Relative Wealth Index"
  ) +
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/drcongo.png",
  width = 12,
  height = 12,
  dpi = 72
)
...
# Read the CSV file
eth_data <- read.csv(
  "sub_pro_2_rel_wealth_index_meta/datasets/eth_relative_wealth_index.csv"
)

# Convert the data to an sf object
eth_data_sf <- st_as_sf(
  eth_data,
  coords = c("longitude", "latitude"),
  crs = 4326
)
...
ggplot() +
  ...
  theme_void() +
  labs(
    title = "Wealth Index Distribution in Ethiopia",
    subtitle = "",
    caption = "Data Source: Meta (Data for Good)",
    color = "Relative Wealth Index"
  ) +
...
ggsave(
  "sub_pro_2_rel_wealth_index_meta/images/ethiopia.png",
  width = 12,
  height = 12,
  dpi = 72
)
